...
#[Fillable(['name', 'email', 'password', 'family_id', 'role', 'is_admin', 'bank_balance_enabled', 'bank_balance', 'bank_balance_set_at', 'view_family_expenses'])]
