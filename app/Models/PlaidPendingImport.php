...
class PlaidPendingImport extends Model
{
    protected $fillable = [
        ...
        'suggested_exclude_from_expense_basis',
        'suggested_is_necessity',
        'suggested_description',
        'suggested_is_debt_payment',
        'suggested_debt_id',
        'suggested_split_data',
        'confidence_score',
        'status',
        'transaction_id',
    ...
    protected function casts(): array
    {
        return [
            ...
            'date' => 'date',
            'raw_payload' => 'array',
            'suggested_exclude_from_expense_basis' => 'bool',
            'suggested_is_necessity' => 'bool',
