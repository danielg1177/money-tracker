...
const routes = [
  ...
  { path: '/bank-connections', component: () => import('../pages/BankConnections.vue'), meta: { requiresAuth: true } },
  { path: '/plaid/import-review', component: () => import('../pages/PlaidImportReview.vue'), meta: { requiresAuth: true } },
  { path: '/plaid/calibrate/:itemId', component: () => import('../pages/PlaidCalibrate.vue'), meta: { requiresAuth: true } },
